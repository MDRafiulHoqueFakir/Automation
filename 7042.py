...
time.sleep(1)
#login
driver.find_element(By.XPATH,value="//input[@id='txtMenuSearch']").send_keys('7042')
press('enter')
#search bar
...
time.sleep(1)
#Amount CCY
driver.find_element(By.XPATH,value="//textarea[@id='ctl00_contPlcHdrMasterHolder_LstxtNarrationCr']").send_keys(10000)
time.sleep(1)
press('enter')
time.sleep(1)
#Narration
...
time.sleep(1)
#GL/Cleient/AC
driver.find_element(By.XPATH,value="//input[@id='ctl00_contPlcHdrMasterHolder_LstxtAmtCcyDr']").send_keys(10000)
time.sleep(1)
press('enter')
time.sleep(1)
#Amount
